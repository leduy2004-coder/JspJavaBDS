...
<c:url var="APIurl" value="/api-admin-hotnew"/>
<c:url var ="NewURL" value="/admin-hot-new"/>
            ...
            <div class="row">
                <div class="col-xs-12">
                        <form id="formSubmit">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="categoryCode" name="categoryCode">
                                        <c:if test="${empty hotmodel.categoryCode}">
                                            <option value="">Chọn loại tin tức</option>
                                            <c:forEach var="item" items="${categories}">
                                                <option value="${item.code}">${item.name}</option>
                                            </c:forEach>
                                        </c:if>
                                        <c:if test="${not empty hotmodel.categoryCode}">
                                            <option value="">Chọn loại tin tức</option>
                                            <c:forEach var="item" items="${categories}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" name="title" value="${hotmodel.title}"/>
                                </div>
                            </div>
    						<br/>
    						<br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="shortDescription" name="shortDescription" value="${hotmodel.shortDescription}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">                                 
                                    <textarea rows="" cols="" id="content" name="content" style="width: 820px;height: 175px;">${hotmodel.content}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <c:if test="${not empty hotmodel.id}">
                                        <input type="button" class="btn btn-white btn-warning btn-bold" value="Cập nhật tin tức" id="btnAddOrUpdateNew"/>
                                    </c:if>
                                    <c:if test="${empty hotmodel.id}">
                                        <input type="button" class="btn btn-white btn-warning btn-bold" value="Thêm tin tức" id="btnAddOrUpdateNew"/>
                                    </c:if>
                                </div>
                            </div>                 
                            <input type="hidden" class="form-control" id="thumbnail" name="thumbnail" value="1"/>
                            <input type="hidden" value="${hotmodel.id}" id="id" name="id"/>
                        </form>
                        <br/>
                        <br/>
             ...
             <form action="${FileURL}" method="POST" enctype="multipart/form-data">
                 			...
                 			<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" id="thumbnail" name="thumbnail" value="${hotmodel.thumbnail}"/>
                                </div>
                            </div>
   							<br/>
                     	    <br/>
                     	    <input type="hidden" value="${hotmodel.id}" id="id" name="id"/>  
                     	    <input type="hidden" value="hotnew" id="hotnew" name="hotnew"/>  
                             <div class="form-group">
                                <div class="col-sm-12">
