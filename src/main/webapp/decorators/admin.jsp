...
<head>
	...
	<link rel="stylesheet" href="<c:url value='/template/admin/css/toast.css' />" />
    ...
    <link rel="stylesheet" href="<c:url value='/template/admin/font-web/fontawesome-free-6.2.0/fontawesome-free-6.2.0-web/css/all.min.css' />">
